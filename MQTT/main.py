...
otlp_http_exporter = OTLPSpanExporter(
    endpoint="https://otelcollector-25d3ca0-jclifford-savingtheholidays-production.deployments.quix.io:80/v1/traces",  # Replace with your Otel Collector HTTP endpoint
